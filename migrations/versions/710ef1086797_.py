...
Revision ID: 710ef1086797
Revises: 21273e98c7bf
Create Date: 2022-03-21 18:00:47.906795
...
revision = '710ef1086797'
down_revision = '21273e98c7bf'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('html_code', sa.String(length=255), nullable=False),
    sa.Column('created_on', sa.DateTime(), nullable=True),
    sa.Column('updated_on', sa.DateTime(), nullable=True),
    sa.Column('deleted_on', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    ...
    sa.Column('default_language', sa.Integer(), nullable=False),
    sa.Column('created_on', sa.DateTime(), nullable=True),
    sa.Column('updated_on', sa.DateTime(), nullable=True),
    sa.Column('deleted_on', sa.DateTime(), nullable=True),
    ...
    sa.Column('customer_id', sa.Integer(), nullable=False),
    sa.Column('workspace_role_id', sa.Integer(), nullable=False),
    sa.Column('created_on', sa.DateTime(), nullable=True),
    sa.Column('updated_on', sa.DateTime(), nullable=True),
    sa.Column('deleted_on', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['customer_id'], ['customer.id'], ondelete='CASCADE'),
