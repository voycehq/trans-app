...
Revision ID: 4e97867c6cb9
Revises: 9abf52af161b
Create Date: 2022-03-20 08:31:07.844460
...
revision = '4e97867c6cb9'
down_revision = '9abf52af161b'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('html_code', sa.String(length=50), nullable=False),
    sa.Column('created_on', sa.DateTime(), nullable=True),
    sa.Column('updated_on', sa.DateTime(), nullable=True),
    sa.Column('deleted_on', sa.DateTime(), nullable=True),
